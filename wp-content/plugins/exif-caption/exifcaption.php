...
add_action( 'plugins_loaded', 'exif_caption_load_textdomain' );
/** ==================================================
 * i18n
 *
 * @since 1.00
 */
function exif_caption_load_textdomain() {
	load_plugin_textdomain( 'exif-caption' );
}

if ( ! class_exists( 'ExifCaptionRegist' ) ) {
	require_once( dirname( __FILE__ ) . '/lib/class-exifcaptionregist.php' );
}
